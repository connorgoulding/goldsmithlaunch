    ...
    <div className="relative min-h-screen bg-[#1A1A1A] flex flex-col items-center justify-center p-6 md:p-12 w-full">
      ...
      <div className="relative z-10 w-full max-w-2xl mt-12 md:mt-24">
        <div className="mb-8 text-center">
          <Link href="/" className="font-mono text-xs text-[#F2F0E9]/50 tracking-widest uppercase hover:text-[#CC5833] transition-colors" data-cursor="hide">
            ← Abort Sequence / Return to Core
          </Link>
        </div>

        {/* The Diagnostic Component set to Consulting logic */}
        <DiagnosticTerminal type="consulting" />
